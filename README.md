...
```bash
tar xvzf gen_pl_pro-4.0.tar.gz
cd gen_pl_pro-4.0
cp -R ~/sh_tool/bin/   /root/scripts/gen_pl_pro/ver.4.0/
cp -R ~/sh_tool/conf/  /root/scripts/gen_pl_pro/ver.4.0/
cp -R ~/sh_tool/log/   /root/scripts/gen_pl_pro/ver.4.0/
```
...
ln -s /root/scripts/gen_pl_pro/ver.4.0/bin/gen_pl_pro.sh /root/bin/gen_pl_pro
