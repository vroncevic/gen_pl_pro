...
Copyright
    ...
    gen_pl_pro is distributed in the hope that it will be useful, but
...
project: str = 'gen_pl_pro'
project_copyright: str = '2026, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '3.0'
release: str = 'https://github.com/vroncevic/gen_pl_pro/releases'
...
htmlhelp_basename: str = 'gen_pl_prodoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_pl_pro.tex', 'gen_pl_pro Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_pl_pro', 'gen_pl_pro Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_pl_pro', 'gen_pl_pro Documentation', author, 'gen_pl_pro',
