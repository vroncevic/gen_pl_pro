...
declare -A GEN_PL_PRO_LOGO_DATA=(
    [OWNER]="vroncevic"
    [REPO]="${GEN_PL_PRO_TOOL}"
    [VERSION]="${GEN_PL_PRO_VERSION}"
    [LOGO]="${GEN_PL_PRO_LOGO}"
)
...
function __gen_pl_pro {
    ...
    display_logo GEN_PL_PRO_LOGO_DATA
